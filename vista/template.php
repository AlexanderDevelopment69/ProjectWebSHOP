...
<html lang="en">
  ...
  <nav class="navbar navbar-expand navbar-light bg-light">
      <div class="nav navbar-nav">
          ...
          <a class="nav-item nav-link" href="?controlador=productos&accion=inicio">Tienda</a>
          <a class="nav-item nav-link" href="?controlador=empleados&accion=inicio">Usuarios</a>
          <a class="nav-item nav-link" href="?controlador=categorias&accion=inicio">Categorias</a>
      </div>
  </nav>
